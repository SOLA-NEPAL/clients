...
<html>
    <head>
        ...
        <title>SOLA-NEPAL Desktop and SOLA-NEPAL Admin Download Page</title>
    </head>
    <body>
        ...
        <table width="80%" cellspacing="0" cellpadding="3">
            <tr>
                <td colspan="2">  
                    <h1><img src="Images/SolaLogo.png"/>Welcome to the download for the SOLA-NEPAL Web Start Alpha Release applications.</h1>
                </td>
            </tr>
            <tr>
                <td width="20%"></td>   
                <td> <br><br>
                    ...
                    <br><br>
                    This page will guide you through the installation of the SOLA-NEPAL Web Start Alpha Release applications which includes the SOLA-NEPAL Desktop Web Start and SOLA-NEPAL Admin Web Start. The installation package for both applications is approximately 70Mb.
                    <br><br> 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="20%"></td>   
                <td>     
                    The  Java SE Runtime Environment 7 is required for the SOLA-NEPAL Web Start applications. Java 7 can be downloaded from <a href="http://www.oracle.com/technetwork/java/javase/downloads/java-se-jre-7-download-432155.html" target="_blank" >here</a>.
                    <ol>
            ...
            <tr>
                ...
                <td>      
                    <ol>
                        ...
                        <li>	The web start application you have selected will start automatically. At the login screen, enter your user name and password
                        <%-- <i><b>test</b></i> and password <i><b>test</b></i>. </li>  --%>
            ...
            <tr>
                ...
                <td>
                    ...
                    <ol>
                        ...
                        <li>	The SOLA-NEPAL Desktop Development Snapshot is an in-progress view of our work to date and may include some defects.If you encounter an issue or bug, you can 
                            notify the SOLA-NEPAL Development Team by sending an email to <a href="mailto:Neil.Pullar@fao.org">Neil.Pullar@fao.org</a>.</li>
                        <%-- <i><b>test</b></i> and password <i><b>test</b></i>. </li>  
