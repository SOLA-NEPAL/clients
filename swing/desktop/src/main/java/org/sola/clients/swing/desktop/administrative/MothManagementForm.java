...
public class MothManagementForm extends ContentPanel {
    ...
    private void initComponents() {
        ...
        newMothMenu.setText(bundle.getString("MothManagementForm.newMothMenu.text")); // NOI18N
        ...
        editMothMenu.setText(bundle.getString("MothManagementForm.editMothMenu.text")); // NOI18N
        ...
        removeMothMenu.setText(bundle.getString("MothManagementForm.removeMothMenu.text")); // NOI18N
        ...
        newPageMenu.setText(bundle.getString("MothManagementForm.newPageMenu.text")); // NOI18N
        ...
        editPageMenu.setText(bundle.getString("MothManagementForm.editPageMenu.text")); // NOI18N
        ...
        multiplePageMenu.setText(bundle.getString("MothManagementForm.multiplePageMenu.text")); // NOI18N
        ...
        removePageMenu.setText(bundle.getString("MothManagementForm.removePageMenu.text")); // NOI18N
        ...
        headerPanel1.setTitleText(bundle.getString("MothManagementForm.headerPanel1.titleText")); // NOI18N

        jLabel4.setText(bundle.getString("MothManagementForm.jLabel4.text")); // NOI18N

        btnSearch.setText(bundle.getString("MothManagementForm.btnSearch.text")); // NOI18N
        ...
        tableMoths.getColumnModel().getColumn(0).setHeaderValue(bundle.getString("MothManagementForm.tableMoths.columnModel.title0")); // NOI18N
        tableMoths.getColumnModel().getColumn(1).setResizable(false);
        tableMoths.getColumnModel().getColumn(1).setHeaderValue(bundle.getString("MothManagementForm.tableMoths.columnModel.title1")); // NOI18N
        tableMoths.getColumnModel().getColumn(2).setResizable(false);
        tableMoths.getColumnModel().getColumn(2).setHeaderValue(bundle.getString("MothManagementForm.tableMoths.columnModel.title2")); // NOI18N

        jToolBar1.setFloatable(false);
        jToolBar1.setRollover(true);

        btnNewMoth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/common/add.png"))); // NOI18N
        btnNewMoth.setText(bundle.getString("MothManagementForm.btnNewMoth.text")); // NOI18N
        ...
        btnEditMoth.setText(bundle.getString("MothManagementForm.btnEditMoth.text")); // NOI18N
        ...
        btnRemoveMoth.setText(bundle.getString("MothManagementForm.btnRemoveMoth.text")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("MothManagementForm.jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(bundle.getString("MothManagementForm.jLabel2.text")); // NOI18N
        ...
        jLabel3.setText(bundle.getString("MothManagementForm.jLabel3.text")); // NOI18N
        ...
        groupPanel1.setTitleText(bundle.getString("MothManagementForm.groupPanel1.titleText")); // NOI18N
        ...
        jLabel5.setText(bundle.getString("MothManagementForm.jLabel5.text")); // NOI18N

        btnSearch1.setText(bundle.getString("MothManagementForm.btnSearch1.text")); // NOI18N
        ...
        btnNewPage.setText(bundle.getString("MothManagementForm.btnNewPage.text")); // NOI18N
        ...
        btnEditPage.setText(bundle.getString("MothManagementForm.btnEditPage.text")); // NOI18N
        ...
        btnMultipleEdit.setText(bundle.getString("MothManagementForm.btnMultipleEdit.text")); // NOI18N
        ...
        btnRemovePage.setText(bundle.getString("MothManagementForm.btnRemovePage.text")); // NOI18N
        ...
        jLabel6.setText(bundle.getString("MothManagementForm.jLabel6.text")); // NOI18N
        ...
        jLabel7.setText(bundle.getString("MothManagementForm.jLabel7.text")); // NOI18N
        ...
        jLabel8.setText(bundle.getString("MothManagementForm.jLabel8.text")); // NOI18N
        ...
        jLabel9.setText(bundle.getString("MothManagementForm.jLabel9.text")); // NOI18N
        ...
        groupPanel2.setTitleText(bundle.getString("MothManagementForm.groupPanel2.titleText")); // NOI18N
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, 607, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
