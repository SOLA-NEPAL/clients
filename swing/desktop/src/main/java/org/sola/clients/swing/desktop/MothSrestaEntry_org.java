 ...
 * @author KumarKhadka
 */
public class MothSrestaEntry_org extends ContentPanel {
    ...
    /**
     * Creates new form MothSrestaEntry_org
     */
    public MothSrestaEntry_org() {
        initComponents();
    }
    ...
    private void mothShrestaEntry() {
        if (!pnlContent.isPanelOpened(MainContentPanel.CARD_LandOwner_Entry)) {
            LandownerDecription_org srchLndOwner = new LandownerDecription_org();
